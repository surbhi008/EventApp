...
const ChatButton = ({isWhite, style, navigation}) => (
  false && <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Chat')}>
    <Icon
      family="GalioExtra"
      size={16}
      name="chat-33"
...
const BasketButton = ({isWhite, style, navigation}) => (
  false && <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Cart')}>
    <Icon
      family="GalioExtra"
      size={16}
      name="basket-simple"
  ...
  renderSearch = () => {
    ...
    return (
      <Input
        ...
        color="black"
        style={styles.search}
        placeholder="Events near by you?"
...
const styles = StyleSheet.create({
  ...
  navbar: {
    ...
    zIndex: 5,backgroundColor: '#F2AF67'
  },
  shadow: {
